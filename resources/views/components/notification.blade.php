@if(session("title"))
    <div id="notification" style="transform: translateX(-50%)" class="z-51 select-none hidden bg-green-600 fixed -top-10 left-[50%] items-center justify-between max-w-90 rounded-md px-7 py-2.5 shadow-md gap-2 duration-300 ease-out animate-popup"> <!-- A notification -->
