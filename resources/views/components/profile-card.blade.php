        ...
        <div class="flex items-center px-7 gap-4 bg-gray-50 rounded-b-[calc(1rem-5px)] bg-[url({{ Vite::asset("resources/images/defaults/cardbg.png") }})] bg-no-repeat bg-contain bg-position-[left_1rem_center]">
            ...
            <div class="flex justify-between flex-col">
                <div class="flex justify-center w-fit">
                    <img src="{{ asset(is_null($user->teams) ? Vite::asset("resources/images/defaults/team_icon.png") : asset("storage/images/defaults/$user->teams->icon_name")) }}" class="h-5 mr-1.5 select-none" alt="Ikona klubu {{ !is_null($user->teams) ? $user->teams->name : "(nie należy)" }}">
