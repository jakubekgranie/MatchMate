...
<nav @if($disabled) id="fillerNav" @endif class="flex items-center justify-between p-6 lg:px-8 {{ !request()->is("/") ? "backdrop-blur-sm shadow-sm bg-white/40" : "hover:backdrop-blur-sm hover:shadow-sm hover:bg-white/40 duration-100" }}" aria-label="Global">
