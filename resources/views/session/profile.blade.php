    ...
    <div class="border-2 border-gray-500/65 bg-white/30 rounded-2xl flex flex-col gap-12 py-7 px-9.5 shadow-sm shadow-gray-300 my-13">
        <div class="flex justify-between items-center">
            <div class="w-full">
                ...
                <x-profile-card :user="User::with('team')->find(Auth::id())" :preview-mode="true"/>
            </div>
                ...
                <div class="m-auto">
                    ...
                    <x-update-form-container class="mt-7">
                        <form method="POST" id="deleteForm" class="h-9" action="/profile/delete">
                            @csrf
                            @method('DELETE')
                            <x-save-button type="submit" :activated="true" class="bg-red-700 hover:bg-red-600 !text-gray-100 h-full w-full" fill="oklch(87.2% 0.01 258.338)" text="Usuń konto">
