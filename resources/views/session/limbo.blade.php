<x-layout page-title="Profil" :flex-center="true">
    <x-update-form-container class="max-w-[33%]">
        ...
        <p class="text-lg">Cześć <b>{{ $user->name }}</b>,<br>
            Twoje konto oczekuje na weryfikację przez kapitana drużyny <strong>{{ $user->team->handle }}</strong>. Do czasu wydania werdyktu jego funkcjonalność jest ograniczona. Zostaniesz powiadomiony mailowo w momencie zmian.<br>
            <br>
            Pozdrawiamy,<br>
