    ...
    <main
        ...
        <div class="mx-12" style="margin-left: 3rem; margin-right: 3rem;">
            ...
            <div class="md:text-lg max-w-140 mb-2" style="margin-bottom: 0.5rem;">
                ...
                <p style="margin: 0;">Oto twój link do potwierdzenia zmiany adresu e-mail:</p>
            </div>
            ...
            <div class="md:text-lg max-w-140 mb-2" style="margin-bottom: 0.5rem;">
                <p class="mb-6" style="margin: 0 0 1.5rem;">
                    Jeżeli nie chciałeś/aś wykonywać żadnych zmian, zignoruj tą wiadomość. Twój e-mail nie
                    zostanie zmieniony.
                </p>
