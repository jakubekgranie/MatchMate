    ...
    <main class="px-5 py-7 bg-stone-200 text-gray-950 m-auto w-fit sm:pl-4">
        <div class="mx-12">
            ...
            <div class="md:text-lg max-w-140 mb-2">
                <p class="mb-3">Cześć <strong>{{ Auth::user()->name }}</strong>,</p>
                <p>Oto twój link do potwierdzenia zmiany adresu e-mail:</p>
            </div>
            <x-save-button title="Potwierdź" text="Potwierdź" class="min-w-fit w-[80%] h-12 m-auto my-5" :activated="true"></x-save-button>
            <div class="md:text-lg max-w-140 mb-2">
